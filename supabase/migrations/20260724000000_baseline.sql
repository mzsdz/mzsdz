-- Baseline: profiles / admin_memos / comments / place_tags
-- Idempotent (safe if objects already exist from SQL Editor).
-- Applied history: npx supabase db push
-- Or mark only: npx supabase migration repair 20260724000000 --status applied
